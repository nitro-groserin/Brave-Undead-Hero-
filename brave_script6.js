const audioPaths = [
  { src: '/sound-box/春嵐（Note.）.mp3', volume: 0.2, id: 'siren' },
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(globalIndex) {
    ...
    if (div1) div1.style.display = (index >= 1 && index < 19) || (index > 34 ) ? 'block' : 'none';
    
    if (div2) div2.style.display = (index >= 18 && index < 35 ) ||(index > 100 && index <= 110 ) || (index > 120 && index <= 130 ) || (index > 140 && index <= 150 ) || (index > 160 && index <= 170 ) || (index > 180 && index <= 190 ) || (index > 200 && index <= 210 ) || (index > 220 && index <= 230 ) ? 'block' : 'none';

    
    if (div3) div3.style.display = (index >= 1 && index < 100 ) || (index > 110 && index <= 115) || (index > 120 ) ? 'block' : 'none';
    

    if (div4) div4.style.display = (index >= 100 && index < 141 ) || (index > 141 && index <= 145 ) ||  (index > 161 && index <= 162 ) || (index > 173 && index <= 174 )  ? 'block' : 'none';

    

    if (div5) div5.style.display = (index >= 19 && index < 35 ) || (index > 100 && index <= 110 ) ||  (index > 120 && index <= 130 ) || (index > 140 ) ? 'block' : 'none';

    
    if (div6) div6.style.display = (index >= 57 && index < 72 ) || (index > 120 && index <= 130 ) || (index > 140 && index <= 150 ) ? 'block' : 'none';
    
    
    if (div7) div7.style.display = (index >= 72 && index < 78 ) || (index > 120 && index <= 130 ) || (index > 140) ? 'block' : 'none';

    
    if (div8) div8.style.display = (index >= 78 && index < 110 ) || (index > 120 && index <= 130 ) || (index > 140 ) ? 'block' : 'none';

    if (div9) div9.style.display = index >= 100 && index < 110 ? 'block' : 'none';
