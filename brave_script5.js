...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(globalIndex) {
    ...
    if (div2) div2.style.display = (index >= 41 && index < 42 ) ||(index > 47 && index <= 48 ) || (index > 50 && index <= 57 ) || (index > 58 && index <= 61 ) || (index > 63 && index <= 64 ) || (index > 65 && index <= 68 ) || (index > 70 && index <= 73 ) || (index > 76 && index <= 780 ) ? 'block' : 'none';
