const audioPaths = [
  { src: 'sound-box/Wind-Synthetic_Ambi02-1.mp3', volume: 0.2, id: 'siren' },
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showPre(globalIndex) {
    ...
    if (div1) div1.style.display = (index >= 150 && index < 100) || (index > 150) ? 'block' : 'none';
    
    if (div2) div2.style.display = (index >= 22 && index < 23 ) || (index > 24 && index <= 72 ) || (index > 73 && index <= 75 ) ? 'block' : 'none';

    
    if (div3) div3.style.display = (index >= 22 && index < 23 ) || (index > 24 && index <= 250) || (index > 120) ? 'block' : 'none';
    

    if (div4) div4.style.display = (index >= 24 && index < 25 ) || (index > 500 && index <= 550 ) || (index > 570 && index <= 640 ) || (index > 650 ) ? 'block' : 'none';

    

    if (div5) div5.style.display = (index >= 23 && index < 24 ) || (index > 110 && index <= 115) || (index > 120) ? 'block' : 'none';
    if (div6) div6.style.display = (index >= 23 && index < 24 ) || (index > 100 && index <= 110) ? 'block' : 'none';
    
    if (div7) div7.style.display = (index >= 24 && index < 25 ) || (index > 640 && index <= 650 ) || (index > 120) ? 'block' : 'none';


    if (div8) div8.style.display = (index >= 24 && index < 25 ) || (index > 640 && index <= 650 ) || (index > 120) ? 'block' : 'none';
  
    
    if (div9) div9.style.display = (index >= 26 && index < 73 ) || (index > 640 && index <= 650 ) || (index > 120) ? 'block' : 'none';


    if (div10) div10.style.display = (index >= 69 && index < 73 ) || (index > 640 && index <= 650 ) || (index > 120) ? 'block' : 'none';


    if (div11) div11.style.display = (index >= 79 && index < 80 ) || (index > 640 && index <= 650 ) || (index > 120) ? 'block' : 'none';
